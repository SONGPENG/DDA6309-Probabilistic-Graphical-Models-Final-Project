...
def train(args):
    ...
    hpara = TCwsPos.init_hyper_parameters(args)
    joint_model = TCwsPos(word2id, gram2id, feature2id, label_map, processor, hpara, args)
...
def test(args):
    ...
    joint_model = TCwsPos.from_spec(joint_model_checkpoint['spec'], joint_model_checkpoint['state_dict'], args)
